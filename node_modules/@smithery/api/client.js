...
const uplink_1 = require("./resources/uplink.js");
const experimental_1 = require("./resources/experimental/experimental.js");
...
class Smithery {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('SMITHERY_BASE_URL'), apiKey = (0, env_1.readEnv)('SMITHERY_API_KEY'), ...opts } = {}) {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Smithery_instances, "m", _Smithery_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
