...
async function translateToChinese(englishText, config) {
    var _a, _b, _c;
...
async function main() {
    ...
    `;
        ...
        const results = await translateBatch(placesToTranslate, llmConfig, batchSize, delayMs, isDryRun);
        console.log('\n=== 翻译完成 ===');
...
//# sourceMappingURL=translate-iceland-poi-namecn-to-chinese.js.map