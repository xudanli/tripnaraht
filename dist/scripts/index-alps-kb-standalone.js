...
function autoChunk(fileData) {
    ...
    if (fileData.filename.includes('attractions')) {
        ...
        attractions.forEach((item, index) => {
            ...
            if ((_a = item.description) === null || _a === void 0 ? void 0 : _a.zh)
                parts.push(`描述: ${item.description.zh}`);
            if ((_b = item.description) === null || _b === void 0 ? void 0 : _b.en)
                parts.push(`English: ${item.description.en}`);
            if ((_c = item.overview) === null || _c === void 0 ? void 0 : _c.zh)
                parts.push(`概述: ${item.overview.zh}`);
            if (item.coordinates)
    ...
    if (fileData.filename.includes('route')) {
        ...
        if ((_b = route.overview) === null || _b === void 0 ? void 0 : _b.zh)
            parts.push(`概述: ${route.overview.zh}`);
        if ((_c = route.overview) === null || _c === void 0 ? void 0 : _c.en)
            parts.push(`Overview: ${route.overview.en}`);
            ...
            if (Array.isArray(sectionData)) {
                sectionData.forEach((risk, idx) => {
                    ...
                    if (risk.affected_areas)
                        parts.push(`影响区域: ${Array.isArray(risk.affected_areas) ? risk.affected_areas.join('、') : risk.affected_areas}`);
...
//# sourceMappingURL=index-alps-kb-standalone.js.map