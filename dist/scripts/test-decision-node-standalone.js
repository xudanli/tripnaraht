...
function testDecisionNode() {
    ...
    console.log(`    Date Range: ${(_a = decisionNode.context.date_range) === null || _a === void 0 ? void 0 : _a.start} to ${(_b = decisionNode.context.date_range) === null || _b === void 0 ? void 0 : _b.end}`);
    console.log(`    Travelers: ${(_c = decisionNode.context.travelers) === null || _c === void 0 ? void 0 : _c.count} (${(_d = decisionNode.context.travelers) === null || _d === void 0 ? void 0 : _d.profile})`);
    ...
    console.log(`    Selected: ${(_e = decisionNode.decision) === null || _e === void 0 ? void 0 : _e.selected_option_id}`);
    console.log(`    Reasoning: ${(_f = decisionNode.decision) === null || _f === void 0 ? void 0 : _f.reasoning}`);
...
main();
//# sourceMappingURL=test-decision-node-standalone.js.map