    ...
    if (fileData.filename.includes('attractions') || fileData.filename.includes('pois')) {
        ...
        attractions.forEach((item, index) => {
            ...
            if (item.significance)
                parts.push(`重要性: ${item.significance}`);
            chunks.push({
    ...
    if (fileData.filename.includes('settlement')) {
        ...
        settlements.forEach((item, index) => {
            ...
            if (item.significance)
                parts.push(`重要性: ${item.significance}`);
            if (item.attractions)
                parts.push(`景点: ${Array.isArray(item.attractions) ? item.attractions.join('、') : item.attractions}`);
            chunks.push({
...
//# sourceMappingURL=index-greenland-kb-standalone.js.map