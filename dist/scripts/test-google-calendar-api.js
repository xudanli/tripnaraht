...
async function testGoogleCalendarAPI() {
    ...
    try {
        await axios_1.default.get(`${BASE_URL}/health`, { timeout: 3000 }).catch(() => {
            return axios_1.default.get(`${BASE_URL}`, { timeout: 3000 });
        });
    ...
    try {
        ...
        if (response.data.success) {
            ...
            throw new Error(((_a = response.data.error) === null || _a === void 0 ? void 0 : _a.message) || '未知错误');
        }
    }
    catch (error) {
        const errorMsg = ((_d = (_c = (_b = error.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.message) || error.message || '连接失败';
    ...
    console.log('\n📋 测试 2: 列出所有日历');
    try {
        const response = await axios_1.default.get(`${API_BASE}/calendars`);
        if (response.data.success) {
            const calendars = ((_e = response.data.data) === null || _e === void 0 ? void 0 : _e.calendars) || [];
            ...
            throw new Error(((_f = response.data.error) === null || _f === void 0 ? void 0 : _f.message) || '未知错误');
        }
    }
    catch (error) {
    ...
    console.log('\n📋 测试 3: 获取当前时间');
    try {
        const response = await axios_1.default.get(`${API_BASE}/current-time`);
        if (response.data.success) {
            logSuccess(`获取当前时间成功: ${(_g = response.data.data) === null || _g === void 0 ? void 0 : _g.dateTime}`);
            results.push({ name: '获取当前时间', success: true, data: response.data.data });
        }
        else {
            throw new Error(((_h = response.data.error) === null || _h === void 0 ? void 0 : _h.message) || '未知错误');
        }
    }
    catch (error) {
    ...
    try {
        ...
        const response = await axios_1.default.get(`${API_BASE}/events`, {
            params: {
                calendarId: 'primary',
        ...
        if (response.data.success) {
            const events = ((_j = response.data.data) === null || _j === void 0 ? void 0 : _j.events) || [];
            ...
            throw new Error(((_k = response.data.error) === null || _k === void 0 ? void 0 : _k.message) || '未知错误');
        }
    }
    catch (error) {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${API_BASE}/events`, eventData);
        if (response.data.success) {
            createdEventId = (_l = response.data.data) === null || _l === void 0 ? void 0 : _l.id;
            logSuccess(`创建事件成功: ${createdEventId}`);
            logInfo(`事件标题: ${(_m = response.data.data) === null || _m === void 0 ? void 0 : _m.summary}`);
            results.push({ name: '创建事件', success: true, data: response.data.data });
        }
        else {
            throw new Error(((_o = response.data.error) === null || _o === void 0 ? void 0 : _o.message) || '未知错误');
        }
    }
    catch (error) {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${API_BASE}/free-slots`, {
            calendarId: 'primary',
            timeMin: now.toISOString(),
        ...
        if (response.data.success) {
            const freeSlots = ((_p = response.data.data) === null || _p === void 0 ? void 0 : _p.freeSlots) || [];
            ...
            throw new Error(((_q = response.data.error) === null || _q === void 0 ? void 0 : _q.message) || '未知错误');
        }
    }
    catch (error) {
    ...
    try {
        ...
        const response = await axios_1.default.post(`${API_BASE}/quick-add`, {
            calendarId: 'primary',
            text: `明天下午2点 TripNara 快速添加测试`,
        });
        if (response.data.success) {
            logSuccess(`快速添加事件成功: ${(_r = response.data.data) === null || _r === void 0 ? void 0 : _r.id}`);
            logInfo(`事件标题: ${(_s = response.data.data) === null || _s === void 0 ? void 0 : _s.summary}`);
            results.push({ name: '快速添加事件', success: true, data: response.data.data });
        }
        else {
            throw new Error(((_t = response.data.error) === null || _t === void 0 ? void 0 : _t.message) || '未知错误');
        }
    }
    catch (error) {
    ...
    if (createdEventId) {
        console.log('\n📋 测试 8: 查找事件');
        try {
            const response = await axios_1.default.post(`${API_BASE}/events/find`, {
                calendarId: 'primary',
                query: 'TripNara 测试',
            });
            if (response.data.success) {
                const events = ((_u = response.data.data) === null || _u === void 0 ? void 0 : _u.events) || [];
                logSuccess(`查找事件成功: 找到 ${events.length} 个匹配的事件`);
                results.push({ name: '查找事件', success: true, data: events });
            }
            else {
                throw new Error(((_v = response.data.error) === null || _v === void 0 ? void 0 : _v.message) || '未知错误');
            }
        }
        catch (error) {
    ...
    if (createdEventId) {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${API_BASE}/events/${createdEventId}/update`, {
                calendarId: 'primary',
            ...
            if (response.data.success) {
                ...
                logInfo(`更新后标题: ${(_w = response.data.data) === null || _w === void 0 ? void 0 : _w.summary}`);
                results.push({ name: '更新事件', success: true, data: response.data.data });
            }
            else {
                throw new Error(((_x = response.data.error) === null || _x === void 0 ? void 0 : _x.message) || '未知错误');
            }
        }
        catch (error) {
    ...
    if (createdEventId) {
        console.log('\n📋 测试 10: 删除日历事件');
        try {
            const response = await axios_1.default.post(`${API_BASE}/events/${createdEventId}/delete`, {
                calendarId: 'primary',
            });
            if (response.data.success) {
                ...
                throw new Error(((_y = response.data.error) === null || _y === void 0 ? void 0 : _y.message) || '未知错误');
            }
        }
        catch (error) {
...
//# sourceMappingURL=test-google-calendar-api.js.map