    ...
    rules: [
        {
            ...
            then: {
                level: 'must',
                message: '路线依赖渡轮，需预留排队时间并准备备选方案。渡轮班次可能因天气取消，建议预留缓冲时间。',
                tasks: [
                    {
                        title: '查询渡轮时刻表和预订信息',
                        dueOffsetDays: -14,
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: '冬季山口自驾风险高，部分山口（如 Trollstigen）可能封闭。必须加 buffer、避免夜间长转场，并准备雪胎/防滑链。',
                tasks: [
                    {
                        title: '检查山口开放状态（出发前）',
                        dueOffsetDays: -1,
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: '极北地区冬季极光活动：光照短、风大体感低。建议保暖分层、相机防潮、携带备用电池。',
                tasks: [
                    {
                        title: '准备保暖装备（分层穿着）',
                        dueOffsetDays: -7,
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: '附近有徒步入口点。建议：准备装备、了解路线难度、日落前回程、携带离线地图。',
                tasks: [
                    {
                        title: '查询路线难度和所需装备',
                        dueOffsetDays: -7,
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: '路线包含充电桩，但建议提前规划充电站位置，避免在偏远地区电量耗尽。',
                tasks: [
                    {
                        title: '规划充电站位置',
                        dueOffsetDays: -7,
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: '极地夜期间（11-2 月）：几乎全天黑暗，需准备头灯、反光装备，避免夜间户外活动。',
                tasks: [
                    {
                        title: '准备头灯和反光装备',
                        dueOffsetDays: -7,
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: '峡湾路线通常需要渡轮连接。建议提前查询渡轮时刻表，预留排队时间，并准备备选路线。',
                tasks: [
                    {
                        title: '查询峡湾渡轮时刻表',
                        dueOffsetDays: -14,
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: '极北地区可能有野生动物（如驯鹿、北极狐等）。建议了解当地野生动物情况，保持安全距离，避免夜间户外活动。',
                tasks: [
                    {
                        title: '了解当地野生动物情况',
                        dueOffsetDays: -7,
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: '极北偏远地区通信信号可能不稳定。建议准备卫星通信设备，并告知他人行程计划。',
                tasks: [
                    {
...
//# sourceMappingURL=norway-pack.example.js.map