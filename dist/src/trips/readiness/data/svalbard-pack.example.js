...
exports.svalbardPack = void 0;
exports.svalbardPack = {
    ...
    rules: [
        {
            ...
            then: {
                level: 'must',
                message: 'Confirm mainland Norway transit/entry requirements (Schengen rules may apply even if Svalbard itself is special).',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: 'If you need a Schengen visa, plan for return transit as well (often treated as re-entry). Prefer a visa that safely covers both directions.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: 'Avoid independent wilderness travel. Use certified guided tours for activities outside settlements due to polar bear risk.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: 'If leaving settlements, follow local safety requirements for polar-bear deterrence/protection. If unsure, do not go without a guide.',
                askUser: [
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: 'Buy travel insurance that covers rescue/medical evacuation and your planned Arctic activities.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Longyearbyen inventory is limited. Book accommodation and key tours early, especially in peak periods.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Build buffer time: weather may cancel flights/tours. Avoid a zero-buffer plan.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: 'Pack layered clothing with wind/waterproof shell; prioritize hands/feet/face warmth.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: 'Polar night: bring a reliable headlamp and spare batteries/power bank.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Polar night: reflective accessories improve visibility during dark conditions.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Polar day: bring sunglasses/eye protection due to continuous bright light and glare.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Svalbard is expensive (lodging/tours/food). Increase budget buffer or reduce high-cost activities.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'must',
                message: 'Choose reputable operators with safety briefings and proper gear (Arctic conditions are unforgiving).',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Remote medical access: confirm coverage for pre-existing conditions and carry essential meds.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Prepare offline backups: offline maps, booking confirmations, emergency contacts.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Before departure, save local emergency contacts and follow local safety guidance.',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Match activities to season: polar night favors aurora/snow; polar day favors hikes/boat wildlife trips.',
                askUser: [
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Carry passport and keep ID documents accessible during travel days (checks can occur).',
                tasks: [
                    {
        ...
        },
        {
            ...
            then: {
                level: 'should',
                message: 'Avoid tight connections; Arctic weather can disrupt flights. Prefer flexible tickets or longer layovers.',
                tasks: [
                    {
...
//# sourceMappingURL=svalbard-pack.example.js.map