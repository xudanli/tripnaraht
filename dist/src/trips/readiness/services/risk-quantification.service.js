...
var RiskQuantificationService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.RiskQuantificationService = void 0;
const common_1 = require("@nestjs/common");
let RiskQuantificationService = RiskQuantificationService_1 = class RiskQuantificationService {
    constructor() {
        this.logger = new common_1.Logger(RiskQuantificationService_1.name);
    }
    quantifyRisk(riskType, severity, context, lang = 'zh') {
    ...
    calculateRiskMetrics(riskType, severity, context, lang = 'zh') {
        switch (riskType) {
    ...
    quantifyWeatherRisk(severity, context, lang = 'zh') {
        const metrics = [];
    ...
    quantifyTerrainRisk(severity, context, lang = 'zh') {
        var _a;
        const metrics = [];
        let levelExplanation;
        if ((_a = context === null || context === void 0 ? void 0 : context.geo) === null || _a === void 0 ? void 0 : _a.mountains) {
    ...
    quantifyWaterSafetyRisk(severity, context, lang = 'zh') {
        const metrics = [];
        let levelExplanation;
        let comparison;
        if (severity === 'high') {
    ...
    quantifyWildlifeRisk(severity, context, lang = 'zh') {
        let levelExplanation;
        if (severity === 'high') {
    ...
    quantifyHealthcareRisk(severity, context, lang = 'zh') {
        const metrics = [];
        let levelExplanation;
        if (severity === 'high') {
            metrics.push({
    ...
    quantifyLogisticsRisk(severity, context, lang = 'zh') {
        const metrics = [];
        let levelExplanation;
        if (severity === 'high') {
            metrics.push({
    ...
    quantifyCrimeRisk(severity, context, lang = 'zh') {
        let levelExplanation;
        if (severity === 'high') {
    ...
    quantifyRegulatoryRisk(severity, context, lang = 'zh') {
        let levelExplanation;
        if (severity === 'high') {
    ...
    estimateProbability(riskType, severity, context) {
        switch (severity) {
...
exports.RiskQuantificationService = RiskQuantificationService;
exports.RiskQuantificationService = RiskQuantificationService = RiskQuantificationService_1 = __decorate([
    (0, common_1.Injectable)()
], RiskQuantificationService);
//# sourceMappingURL=risk-quantification.service.js.map