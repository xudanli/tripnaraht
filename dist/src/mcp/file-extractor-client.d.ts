...
export declare class FileExtractorOAuthProvider implements OAuthClientProvider {
    private serverUrl;
    private clientName;
    private tokenFile;
...
export declare class FileExtractorMcpClient {
    private client;
    private transport;
    private isConnected;
    private serverUrl;
...
export declare function getFileExtractorClient(): FileExtractorMcpClient;
