...
var FileExtractorMcpController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.FileExtractorMcpController = void 0;
...
let FileExtractorMcpController = FileExtractorMcpController_1 = class FileExtractorMcpController {
    constructor(fileExtractorMcpService) {
        this.fileExtractorMcpService = fileExtractorMcpService;
        this.logger = new common_1.Logger(FileExtractorMcpController_1.name);
    }
    health() {
    ...
    async listTools() {
        try {
            if (!this.fileExtractorMcpService.isAvailable()) {
                return (0, standard_response_dto_1.errorResponse)(standard_response_dto_1.ErrorCode.INTERNAL_ERROR, 'File Extractor MCP service is not available. Please check configuration.');
            }
            const tools = await this.fileExtractorMcpService.listTools();
            return (0, standard_response_dto_1.successResponse)({ tools: tools.tools || [] });
        }
        catch (error) {
...
exports.FileExtractorMcpController = FileExtractorMcpController;
__decorate([
...
], FileExtractorMcpController.prototype, "health", null);
__decorate([
...
], FileExtractorMcpController.prototype, "listTools", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], FileExtractorMcpController.prototype, "extractMetadata", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], FileExtractorMcpController.prototype, "extractFileContent", null);
exports.FileExtractorMcpController = FileExtractorMcpController = FileExtractorMcpController_1 = __decorate([
    (0, swagger_1.ApiTags)('file-extractor-mcp'),
    (0, common_1.Controller)('file-extractor-mcp'),
    (0, public_decorator_1.Public)(),
    __metadata("design:paramtypes", [file_extractor_mcp_service_1.FileExtractorMcpService])
], FileExtractorMcpController);
//# sourceMappingURL=file-extractor-mcp.controller.js.map