...
var ExaMonitoringService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ExaMonitoringService = void 0;
const common_1 = require("@nestjs/common");
const redis_service_1 = require("../redis/redis.service");
let ExaMonitoringService = ExaMonitoringService_1 = class ExaMonitoringService {
    constructor(redisService) {
        this.redisService = redisService;
        this.logger = new common_1.Logger(ExaMonitoringService_1.name);
        this.metricsKeyPrefix = 'exa:metrics:';
        this.statsKeyPrefix = 'exa:stats:';
        this.pricing = {
            web_search_exa: 0.001,
            deep_search_exa: 0.002,
            crawling_exa: 0.0005,
            deep_researcher_start: 0.005,
            deep_researcher_check: 0.0001,
            default: 0.001,
        };
    }
    async onModuleInit() {
    ...
    async recordCall(metrics) {
        try {
            ...
            this.logger.debug(`Exa API call: ${metrics.toolName} - ${metrics.success ? 'success' : 'failed'} ` +
    ...
    async checkCostLimit(dailyLimit = 10) {
...
exports.ExaMonitoringService = ExaMonitoringService;
exports.ExaMonitoringService = ExaMonitoringService = ExaMonitoringService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Optional)()),
    __metadata("design:paramtypes", [redis_service_1.RedisService])
], ExaMonitoringService);
//# sourceMappingURL=exa-monitoring.service.js.map