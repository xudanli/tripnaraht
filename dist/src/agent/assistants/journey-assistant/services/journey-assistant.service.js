...
var JourneyAssistantService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.JourneyAssistantService = void 0;
...
let JourneyAssistantService = JourneyAssistantService_1 = class JourneyAssistantService {
    constructor(coreGateway, llmExecutor, prisma, llmService, executionAgent, personaShell) {
        ...
        this.logger = new common_1.Logger(JourneyAssistantService_1.name);
    ...
    async handleGetReminders(request) {
        const state = await this.loadJourneyState(request.tripId, request.userId);
    ...
    async handleAdjustSchedule(request) {
        var _a;
        ...
        if (this.coreGateway) {
            const changeIntent = {
                intentId: (0, crypto_1.randomUUID)(),
            ...
            try {
                ...
                if (result.success) {
                    ...
                    this.logger.warn(`[行程助手] CoreGateway 返回失败: ${(_a = result.error) === null || _a === void 0 ? void 0 : _a.message}`);
                }
            }
            catch (error) {
    ...
    async handleNearbySearch(request, state) {
...
需要我帮你导航到哪一家吗？`,
    ...
    async handleScheduleQuery(request, state) {
        var _a, _b;
        ...
        schedule.forEach((item, index) => {
            var _a;
            const time = ((_a = item.startTime.split('T')[1]) === null || _a === void 0 ? void 0 : _a.substring(0, 5)) || item.startTime;
...
${scheduleText}
Currently: ${((_a = this.getCurrentActivity(state)) === null || _a === void 0 ? void 0 : _a.title) || 'Free time'}

Anything you'd like to adjust?`,
            messageCN: `这是你今天的行程（第${state.currentDay}天）：

${scheduleTextCN}
当前：${((_b = this.getCurrentActivity(state)) === null || _b === void 0 ? void 0 : _b.titleCN) || '自由时间'}

需要调整什么吗？`,
            journeyState: state,
        };
    }
    async handleNavigation(request, state) {
        return {
...
一路顺风！`,
    ...
    async handleRecommendation(request, state) {
        return {
...
你想做什么？`,
    ...
    async handleEmergencyChat(request, state) {
        return {
...
保持冷静，我会帮你处理。`,
    ...
    async handleAdjustmentChat(request, state) {
        return {
...
告诉我你的需求！`,
    ...
    async handleGeneralChat(request, state) {
        return {
...
需要什么帮助？`,
    ...
    generatePreTripReminders(state, now) {
        return [
            {
    ...
    generateDepartureDayReminders(state, now) {
        return [
            {
                id: (0, crypto_1.randomUUID)(),
                type: 'FLIGHT',
    ...
    generateOnTripReminders(state, now) {
        const reminders = [];
    ...
    generateReturnDayReminders(state, now) {
        return [
            {
                id: (0, crypto_1.randomUUID)(),
                type: 'FLIGHT',
    ...
    async loadJourneyState(tripId, userId) {
...
已用预算：¥${state.stats.spentBudget * 7}/¥${state.stats.totalBudget * 7}`,
    ...
    async generateEmergencyOptions(event, state) {
    ...
    async executeSelectedOption(request, state, event) {
        return {
    ...
    async sendPushNotifications(userId, tripId, reminders) {
...
exports.JourneyAssistantService = JourneyAssistantService;
__decorate([
    (0, schedule_1.Cron)('0 */30 * * * *'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], JourneyAssistantService.prototype, "proactiveReminderCheck", null);
exports.JourneyAssistantService = JourneyAssistantService = JourneyAssistantService_1 = __decorate([
...
//# sourceMappingURL=journey-assistant.service.js.map