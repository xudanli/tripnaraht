...
var ReactSystemPromptService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ReactSystemPromptService = void 0;
const common_1 = require("@nestjs/common");
const action_registry_service_1 = require("./action-registry.service");
let ReactSystemPromptService = ReactSystemPromptService_1 = class ReactSystemPromptService {
    constructor(actionRegistry) {
        this.actionRegistry = actionRegistry;
        this.logger = new common_1.Logger(ReactSystemPromptService_1.name);
    }
    generateSystemPrompt(options = {}) {
        const { currentTime = new Date().toISOString(), includeToolSchemas = true, customInstructions = '', } = options;
...
`;
    ...
    generateToolSchemasSection() {
        ...
        const toolDescriptions = actions.map(action => {
            ...
            const preconditions = ((_a = metadata.preconditions) === null || _a === void 0 ? void 0 : _a.length)
    ...
    generateCompactPrompt(options = {}) {
        const { currentTime = new Date().toISOString(), customInstructions = '', } = options;
        return `# ReAct Agent
...
`;
    ...
    generatePromptForScenario(scenario, options = {}) {
...
exports.ReactSystemPromptService = ReactSystemPromptService;
exports.ReactSystemPromptService = ReactSystemPromptService = ReactSystemPromptService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [action_registry_service_1.ActionRegistryService])
], ReactSystemPromptService);
//# sourceMappingURL=react-system-prompt.service.js.map