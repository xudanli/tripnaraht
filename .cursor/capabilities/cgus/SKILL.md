...
name: cgus
description: >-
  TripNARA CGUS 与期望效用工程上下文（显式 /cgus 调用）。载入 cgus-engineering
  全量说明、优化栈与 manifest 运筹角色快捷句。
disable-model-invocation: true
---

# /cgus — CGUS 工程小队上下文

用户已通过 **`/cgus`** 唤起本上下文。在回复或改代码前：

1. **必读**：用 Read 工具读取 `.cursor/capabilities/cgus-engineering/SKILL.md` 全文，并以其为代码地图与验收标准。
