...
function poiTraceForDisplay(t: RouteAndRunApiResult["poi_trace"]): Record<string, unknown> {
  ...
  return {
    ...
    recall_raw_research: t.recall_raw_research,
    recall_after_route_augment: t.recall_after_route_augment,
    after_dedupe: t.after_dedupe,
    after_hard_guards: t.after_hard_guards,
    destination_country: t.destination_country,
    route_direction_id: t.route_direction_id,
    route_signature_pois_added: t.route_signature_pois_added,
    route_corridor_pois_added: t.route_corridor_pois_added,
