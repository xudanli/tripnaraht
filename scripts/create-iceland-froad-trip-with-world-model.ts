 ...
 * 3. 使用 world.buildContext 构建世界模型
 * 4. 展示世界模型的各个组成部分
 */
...
// 冰岛 F 路关键 POI（从 highland-froad-pois.json）
const FROAD_POIS = [
...
async function findOrCreatePlace(prisma: PrismaService, poi: typeof FROAD_POIS[0]) {
  // 尝试查找现有的 Place（通过 nameCN 或 nameEN，并通过 City 关联查询国家代码）
