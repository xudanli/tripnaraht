...
7. **首席AI科学家** (`chief-ai-scientist.md`) ⭐ 高优先级
   - AI技术评估、模型选择与优化、多智能体系统设计、RAG系统优化、实验设计与评估

8. **地理科学家** (`geographic-scientist.md`) ⭐ 中优先级
   - 地理空间数据分析、地形建模、可达性评估、地理风险评估、空间查询优化

9. **用户体验专家** (`ux-expert.md`) ⭐ 中优先级
   - 用户研究、信息架构设计、交互设计、可用性评估、决策可解释性设计

10. **心理学家** (`psychologist.md`) ⭐ 中优先级
    - 用户决策心理分析、认知负荷评估、信任建立机制设计、行为偏差识别与纠正、压力与焦虑管理

### 基础设施与工程角色

11. **数据库工程师** (`database-engineer.md`) ⭐ 高优先级
    - 数据库架构设计、查询性能优化、数据迁移策略

12. **DevOps 工程师** (`devops-engineer.md`) ⭐ 高优先级
    - CI/CD 流程设计、容器化策略、监控系统设计

13. **测试工程师** (`test-engineer.md`) ⭐ 中优先级
    - 测试策略设计、测试用例编写、回归测试集维护

14. **数据工程师** (`data-engineer.md`) ⭐ 中优先级
    - 数据管道设计（ETL）、数据质量监控、地理空间数据处理

15. **前端工程师** (`frontend-engineer.md`) ⭐ 中优先级
    - 前端架构设计、API 接口对接、状态管理

16. **安全工程师** (`security-engineer.md`) ⭐ 低优先级（但重要）
    - 安全架构设计、认证和授权策略、API 安全

17. **量子计算领域科学家** (`quantum-computing-scientist.md`) ⭐ 研究优先级
    - 量子算法评估、问题映射（QUBO/Ising）、量子-经典混合优化架构设计
