...
export class FileOAuthProvider implements OAuthClientProvider {
  ...
  constructor(private serverUrl: string, private clientName: string = 'TripNara Rail Client') {
    // 创建配置目录
...
export class RailMcpClient {
  private client: Client | null = null;
  private transport: StreamableHTTPClientTransport | null = null;
  private isConnected = false;
  private serverUrl: string;

  constructor(serverUrl: string = 'https://server.smithery.ai/DeniseLewis200081/rail') {
...
// 单例实例
let railClientInstance: RailMcpClient | null = null;

/**
 * 获取 Rail MCP 客户端单例
 */
export function getRailClient(): RailMcpClient {
