// src/agent/assistants/planning-assistant/services/llm-tool-selector.service.ts

/**
 * LLM Tool Selector Service
 * 
 * 职责:
 * - 使用 LLM 智能选择最合适的工具
 * - 从用户消息中提取工具参数
...
@Injectable()
export class LlmToolSelectorService {
  private readonly logger = new Logger(LlmToolSelectorService.name);
