...
export class CountryConfigService {
  ...
  async loadRoadStatusData(countryCode: string, subregion?: string): Promise<any> {
    return this.loadJsonFileCached(this.getRoadStatusPath(countryCode, subregion), 'road-status');
  }
  ...
  async loadWeatherWindowsData(countryCode: string, subregion?: string): Promise<any> {
    return this.loadJsonFileCached(this.getWeatherWindowsPath(countryCode, subregion), 'weather-windows');
  }
  ...
  async loadFerrySchedulesData(countryCode: string, subregion?: string): Promise<any> {
    return this.loadJsonFileCached(this.getFerrySchedulesPath(countryCode, subregion), 'ferry-schedules');
  }
