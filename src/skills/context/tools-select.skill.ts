...
export class ToolsSelectSkill implements Skill<ToolsSelectInput, ToolsSelectOutput> {
  ...
  private selectToolsByPhase(phase: string, allSkills: any[]): any[] {
    const phaseToolMap: Record<string, string[]> = {
      ...
      repair: ['trip.applyEdit', 'itinerary.smart_update', 'decision.neptuneRepair', 'plan.selectSlices'],
      readiness: [
  ...
  private selectToolsByQuery(userQuery: string, allSkills: any[]): any[] {
    ...
    const keywords: Record<string, string[]> = {
      ...
      tools: ['tools.select'],
      改行程: ['trip.applyEdit', 'itinerary.smart_update', 'itinerary.verify'],
      修改行程: ['trip.applyEdit', 'itinerary.smart_update'],
      调整行程: ['trip.applyEdit', 'itinerary.smart_update', 'plan.selectSlices'],
