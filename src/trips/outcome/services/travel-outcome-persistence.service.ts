...
export class TravelOutcomePersistenceService {
    ...
    try {
      ...
      await this.prisma.travelOutcome.create({
        data: {
          ...
          companionSatisfaction: outcome.companionSatisfaction,
          companionMatchScore: outcome.companionMatchScore,
          companionCount: outcome.companionCount,
          satisfiedCompanions: outcome.satisfiedCompanions,
  ...
  private mapToTravelOutcome(record: any): TravelOutcome {
    return {
      ...
      companionSatisfaction: record.companionSatisfaction,
      companionMatchScore: record.companionMatchScore,
      companionCount: record.companionCount,
      satisfiedCompanions: record.satisfiedCompanions,
