// src/trips/nl-clarification/config/iceland-clarification.config.ts
 ...
 * 
 * 基于冰岛用户人物设定和分层澄清决策框架
 * 数据来源：冰岛旅游局用户数据、旅游平台用户分析、本地向导反馈
 */
export const ICELAND_CONFIG_TEMPLATE: DestinationClarificationConfig = {
  destinationCode: 'IS',
  destinationName: '冰岛',
  enabled: true,
  metadata: {
