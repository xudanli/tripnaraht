// src/trips/nl-clarification/config/alps-clarification.config.ts
 ...
 * 阿尔卑斯配置模板
 * 
 * 基于阿尔卑斯山徒步和登山者用户画像系统（分层结构版）
 * 数据来源：SBB铁路和缆车运营商官方数据、SAC/CAF会员数据、IFMGA向导经验、直升机救援和保险公司事故数据
 */
export const ALPS_CONFIG_TEMPLATE: DestinationClarificationConfig = {
  destinationCode: 'AL', // 阿尔卑斯（Alps）- 注意：跨越多国（瑞士、法国、意大利、奥地利等）
  ...
  userPersonas: ALPS_USER_PERSONAS,
  clarificationRounds: [
    {
