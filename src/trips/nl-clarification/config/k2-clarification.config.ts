// src/trips/nl-clarification/config/k2-clarification.config.ts
// K2（乔戈里峰）目的地澄清配置
// ⚠️ Layer 1 红线警告：K2是14座8000米峰中综合难度最高的山峰，死亡率约23%
...
export const K2_CONFIG_TEMPLATE: DestinationClarificationConfig = {
  destinationCode: 'K2',
