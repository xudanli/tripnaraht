// src/trips/nl-clarification/config/svalbard-clarification.config.ts
 ...
 * 
 * 基于斯瓦尔巴极地访问者用户画像系统
 * 数据来源：Visit Svalbard官方数据、北极探险公司反馈、极地向导安全记录、用户体验研究
 * 
 * 关键原则：安全优先 - 早期发现'不适合者'比优化体验更重要，因为风险是致命的
 */
export const SVALBARD_CONFIG_TEMPLATE: DestinationClarificationConfig = {
  destinationCode: 'SJ',
  ...
  userPersonas: SVALBARD_USER_PERSONAS,
  clarificationRounds: [
    {
