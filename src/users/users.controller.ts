...
import { Controller, Get, Put, Body, BadRequestException, NotFoundException, Query, Param, ParseIntPipe } from '@nestjs/common';
...
export class UsersController {
  ...
  @ApiOperation({
    summary: '获取用户列表（管理接口）',
    description: '获取用户列表，支持分页、搜索、筛选。需要管理员权限。',
  })
  ...
  @ApiOperation({
    summary: '更新用户信息（管理接口）',
    description: '更新用户信息，包括显示名称、邮箱、邮箱验证状态、头像等。需要管理员权限。',
  })
  @ApiParam({ name: 'id', description: '用户ID', type: String })
